# Operator Quickstart — Repair of consumer electronics

Shortest path from clone to a verified local dry-run for **ISIC 9521** (`cloud-itonami-isic-9521`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9521.git
cd cloud-itonami-isic-9521
```
...
- Likely source path: `repairshop.governor.cljc`
